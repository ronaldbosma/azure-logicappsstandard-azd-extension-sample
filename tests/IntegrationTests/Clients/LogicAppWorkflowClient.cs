...
namespace IntegrationTests.Clients
{
    ...
    internal class LogicAppWorkflowClient : IDisposable
    {
        ...
        public LogicAppWorkflowClient(string tenantId, string subscriptionId, string resourceGroupName, string logicAppName, string workflowName)
            : this(tenantId, subscriptionId, resourceGroupName, logicAppName, workflowName, "When_an_HTTP_request_is_received")
        {
        }
        ...
        /// <summary>
        /// Sends a POST request to the Logic App workflow trigger with the specified data serialized as plain text.
        /// </summary>
